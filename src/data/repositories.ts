...
export const parentRepository = {
  ...
  updateVideo: (id: string, body: { parentLabel?: string; categoryIds?: string[]; isActive?: boolean; playbackStartSeconds?: number; playbackEndSeconds?: number | null }) => write<{ ok: true }>(`/api/parent/videos/${encodeURIComponent(id)}`, "PATCH", body),
